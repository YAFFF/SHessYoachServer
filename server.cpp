...
WebSocketServer::WebSocketServer() : acceptor_(ioc_) {
...
void WebSocketServer::accept() {
  acceptor_.async_accept(
      ...
      beast::bind_front_handler(&WebSocketServer::handle_accept, this));
}
...
void WebSocketServer::handle_accept(beast::error_code ec, tcp::socket socket) {
  ...
  ws.async_accept(net::bind_executor(
      net::make_strand(ioc_), [this, &ws](beast::error_code ec) {
        if (ec) {
        ...
        ws.async_read(
            ...
            net::bind_executor(
                net::make_strand(ioc_),
                [this, &ws, &buffer](beast::error_code ec,
